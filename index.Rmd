...
The features of all artists will be compared to the features of Revenge of the Dreamers III. The three interesting songs of the album will also be looked into more by the use of tempo-, key- and chromagrams. The results of this comparison  and the grams can suggest which artists are most similar to the collaborative album. This hypothesis can be tested with the use of clustering. By means of clustering, it is possible to estimate what artist would be most likely to have written the song, because it is most similar to their own songs.
...
This is why these songs are plotted in the tempograms. Based on these plots, it is easy to say that the tempo of the songs are changing all the time, especially for the song 1993. Because a lot of artists participate in the songs, it is possible that the 


### Clustering estimation for the RoTD III songs
